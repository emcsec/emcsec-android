...
public class KeyCrypterScrypt implements KeyCrypter {
    ...
    public KeyCrypterScrypt() {
        ScryptParameters.Builder scryptParametersBuilder = ScryptParameters.newBuilder().setSalt(
    ...
    public KeyCrypterScrypt(int iterations) {
        ScryptParameters.Builder scryptParametersBuilder = ScryptParameters.newBuilder()
