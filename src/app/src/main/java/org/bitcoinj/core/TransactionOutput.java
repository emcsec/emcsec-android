...
public class TransactionOutput extends ChildMessage {
    ...
    public Script getScriptPubKey() throws org.bitcoinj.script.ScriptException {
    ...
    @Nullable
    @Deprecated
    public LegacyAddress getAddressFromP2PKHScript(NetworkParameters params) throws org.bitcoinj.script.ScriptException {
    ...
    @Nullable
    @Deprecated
    public LegacyAddress getAddressFromP2SH(NetworkParameters params) throws org.bitcoinj.script.ScriptException {
    ...
    */
    ...
    public boolean isWatched(TransactionBag transactionBag) {
        ...
        } catch (org.bitcoinj.script.ScriptException e) {
