...
public class Script {
    ...
    public byte[] getPubKey() throws ScriptException {
        if (chunks.size() != 2) {
            throw new ScriptException(ScriptError.SCRIPT_ERR_BAD_OPCODE, "Script not of right size, expecting 2 but got " + chunks.size());
        }
        ...
        if (chunk0data != null && chunk0data.length > 2 && chunk1data != null && chunk1data.length > 2) {
            ...
            throw new ScriptException(ScriptError.SCRIPT_ERR_BAD_OPCODE, "Script did not match expected form: " + this);
        }
    }
