...
@Entity(tableName = "btc_transaction")
public class BtcTransaction implements Comparable {
    ...
    public BtcTransaction(String address, String category, String amount, String fee, String tx_id, String block) {
    ...
    public BtcTransaction(String date, String address, String category, String amount, String fee, String tx_id, String block, List<Input> inputList, long totalAmountInOutPuts) {
        this.date = date;
        this.address = address;
        this.category = category;
        this.amount = amount;
...
//    }
    ...
    public int compareTo(@NonNull Object o) {
        String date = ((BtcTransaction) o).getDate();
