...
@Entity(tableName = "utxo_emercoin_from_change")
public class UTXOEmercoinFromChange {
    ...
    public UTXOEmercoinFromChange(String tx_id, long index, long value, String address, long timeToRemove) {
        this.tx_id = tx_id;
        this.index = index;
        this.value = value;
        this.address = address;
