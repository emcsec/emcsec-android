...
public class BitcoinAddressesForChangeAdapter extends RecyclerView
        .Adapter<BitcoinAddressesForChangeAdapter.AddressesBitcoinViewHolder> {

    private List<BtcAddressForChange> mListAddresses;
    private final ViewBinderHelper binderHelper = new ViewBinderHelper();
    private BitcoinAddressesAdapter.OnAddressClickedListener listener;

    public BitcoinAddressesForChangeAdapter(List<BtcAddressForChange> mAddresses,
                                            BitcoinAddressesAdapter.OnAddressClickedListener listener) {
